              ...
              <button
                ...
                className={`w-full flex items-start gap-4 px-4 py-3 rounded-xl text-left transition-all ${
                  selectedGrade === grade
                    ...
                    : 'bg-[rgba(255,255,255,0.02)] border border-[var(--border)] hover:border-[rgba(224,32,32,0.3)]'
                }`}
              >
                ...
                {selectedGrade === grade && (
                  <span className="text-[var(--slice-text)] text-xs shrink-0 mt-0.5">&check;</span>
                )}
              </button>
            ))}
          </div>
