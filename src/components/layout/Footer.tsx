      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-10 flex flex-col gap-5">
        <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
          ...
          <nav className="flex flex-wrap items-center gap-x-5 gap-y-2">
            <Link href="/privacy" className="label text-[var(--ink-faint)] hover:text-[var(--ink-dim)] transition-colors">
              Privacy
            </Link>
            <Link href="/terms" className="label text-[var(--ink-faint)] hover:text-[var(--ink-dim)] transition-colors">
              Terms
            </Link>
            <Link href="/contact" className="label text-[var(--ink-faint)] hover:text-[var(--ink-dim)] transition-colors">
              Contact
            </Link>
          </nav>
        </div>

        <div className="label text-[var(--ink-faint)] leading-relaxed max-w-3xl">
