...
export default function TVsPage() {
  return <CategoryIndex category="tv" title="TVs" description="Compare TV prices across every UK retailer. OLED, QLED, Mini-LED — every saving layer from cashback to price matching." />
}
