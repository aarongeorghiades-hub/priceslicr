...
export async function generateStaticParams() {
  const slugs = await getProductSlugsForCategory('phone')
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://priceslicr.com/phones/${slug}`,
    },
    alternates: {
      canonical: `https://priceslicr.com/phones/${slug}`,
    },
  }
}

export default async function PhoneProductPage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
